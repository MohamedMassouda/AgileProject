...
function EventDescription({ event, onBack, customSectionTitle, customSectionDescription }) {
    ...
    <div className="event-description">
      ...
      <div className="event-body">
        <div className="event-details">
          ...
          {showMap && (
            <div className="map">
              <iframe title="Event Location Map" src={`https://www.google.com/maps/embed/v1/place?q=${event.location}&key=YOUR_API_KEY`} width="600" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy"></iframe>
            </div>
          )}
        </div>
